...
# fixture_id_mapping.to_csv("data/interim/fixture_id_mapping.csv", index=False)
...
match_odds = AddMatchOdds("data/raw/2020-21/odds/E0.csv",
                          ...
                          "data/interim/fixture_id_mapping.csv")

combined_odds = match_odds.get_preprocessed_odds()
fixture_mapping = pd.read_csv("data/interim/fixture_id_mapping.csv")
...
print(player_data_with_odds.isna().sum())
