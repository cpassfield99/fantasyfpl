...
df = pd.read_csv("data/processed_data/data_with_odds.csv")
...
player_model = Modelling(df, high_scoring_gks, gk_columns, KNeighborsRegressor(), kneighbors_parameters)
...
# player_model.tpot_modelling(['David de Gea'], gk_columns, 20)
